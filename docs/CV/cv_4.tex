...
\begin{rSection}{Summary}
      \textbf{Space is romantic!}
      I'm epxloring how to use low-cost, miniature wireless sensor systems to facilitate future planetary exploration.
      I designed the smallest rover that has been ever sent to the Moon (by human beings), which I named the "AstroAnt".
\end{rSection}
...
\begin{rSubsection}{AstroAnt - my designed robot is sent to the Moon!}{Jan 2021 --- Mar 2023}{ }{MIT Media Lab}
...
\begin{rSubsection}{LunarWSN (Master thesis in MIT)}{Nov 2020 --- Aug 2021}{ }{MIT Media Lab}
