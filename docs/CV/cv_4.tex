...
\item \textbf{Liu, F}. and Paradiso, J.A., 2023, October.
PrintedCircuit Board (PCB) Probe Tester (PCBPT)-a Compact Desktop Systemthat Helps with Automatic PCBDebugging.
In Adjunct Proceedings of the 36th Annual ACM Symposium on User Interface Software and Technology (pp. 1-3).
\smallskip
\smallskip
\smallskip
