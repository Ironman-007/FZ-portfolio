...
\begin{rSection}{Key passion}
  Leveraging minaiture robotics and
  wireless sensor networks to facilite
  future space explroation,
  especially for in-orbit spacecraft real-time inspection
  and planetary surface in-situ exploration.
\end{rSection}
...
\begin{rSection}{Proof of excellence}
  ...
  It is one of the smallest rover and the first Bluetooth device that has ever been sent to the Moon.
\end{rSection}
