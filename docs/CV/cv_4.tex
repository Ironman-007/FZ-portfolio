...
\begin{rSection}{Key passion}
  Leveraging minaiture robotics and wireless sensor networks to facilite
  future space explroation,
  especially for in-orbit spacecraft inspection and planetary in-situ exploration missions.
\end{rSection}
